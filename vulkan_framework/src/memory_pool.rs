...
impl MemoryPool
{
    ...
    pub fn new(memory_heap: Arc<MemoryHeap>, allocator_builder: &dyn MemoryAllocatorBuilder) -> VulkanResult<Arc<Self>> {
        let allocator = allocator_builder.build(memory_heap.total_size());

...
impl RaytracingBindingTables {
    ...
    pub fn new(
        ...
        match device.ray_tracing_info() {
            Some(rt_info) => match device.ash_ext_raytracing_pipeline_khr() {
                Some(rt_ext) => {
                    ...
                    match unsafe {
                        ...
                        Ok(shader_handle_storage) => {
                            let raygen_buffer =
                                Buffer::new(memory_pool.clone(), buffer_descriptor, None, None)
                                    .unwrap();
                            memory_pool
                                .write_raw_data(

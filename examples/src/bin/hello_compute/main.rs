        ...
        Ok(queue) => {
            ...
            match MemoryHeap::new(
                ...
                Ok(memory_heap) => {
                    ...
                    let command_pool =
                        match CommandPool::new(queue_family.clone(), Some("My command pool")) {
                            Ok(res) => {
                    ...
                    let descriptor_set =
                        match DescriptorSet::new(descriptor_pool, descriptor_set_layout) {
                            Ok(res) => {
                    ...
                    let command_buffer =
                        match PrimaryCommandBuffer::new(command_pool, Some("my command buffer <3"))
                        {
                            Ok(res) => {
